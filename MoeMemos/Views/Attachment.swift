...
struct Attachment_Previews: PreviewProvider {
    static var previews: some View {
        Attachment(resource: Resource(id: "attachments/0", createdTs: Date(), creatorId: "", filename: "test.yml", size: 0, type: "application/x-yaml", updatedTs: Date(), externalLink: nil, publicId: nil, name: "attachments/0", uid: ""))
