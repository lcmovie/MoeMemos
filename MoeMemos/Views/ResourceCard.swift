...
struct ResourceCard_Previews: PreviewProvider {
    static var previews: some View {
        ResourceCard(resource: Resource(id: "attachments/1", createdTs: .now, creatorId: "", filename: "", size: 0, type: "image/jpeg", updatedTs: .now, externalLink: nil, publicId: nil, name: "attachments/1", uid: ""), resourceManager: ResourceListViewModel())
